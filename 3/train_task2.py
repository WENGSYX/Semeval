...
CFG = { #训练的参数配置
    'fold_num': 5, #五折交叉验证
    'seed': 42,
    'model': 'deberta_v3_large_fintune_by2', #task1 微调后的模型
...
train = pd.read_pickle('it_train_task2.pk')

valid = pd.read_pickle('en_subtask2_valid.pk')
valid_fr = pd.read_pickle('fr_subtask2_valid.pk')
valid_it = pd.read_pickle('it_subtask2_valid.pk')
...
model.load_state_dict(torch.load(r'log\deberta_large_fintune_all_fr_en_language_mse_fgm_task2\9_0.8148867491533831_0.8674383673431836_0.7155398328989375_model.pt',map_location='cpu'))
...
log_name = 'deberta_large_fanyi_language_mse_fgm_task2'
