...
CFG = { #训练的参数配置
    'fold_num': 5, #五折交叉验证
    'seed': 1,
    'model': 'microsoft/deberta-v3-large', #预训练模型
...
valid = pd.read_pickle('en_subtask1_valid.pk')
valid_fr = pd.read_pickle('fr_subtask1_valid.pk')
valid_it = pd.read_pickle('it_subtask1_valid.pk')
...
log_name = 'deberta_large_fgm_task1'
