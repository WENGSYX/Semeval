...
CFG = { #训练的参数配置
    'fold_num': 5, #五折交叉验证
    'seed': 42,
    'model': r'C:\semeval\3\paperlog\mdeberta_base_task1\5_0.8999893853454551_0.8891231030760258_0.9221705814263593_model', #预训练模型
...
log_name = 'mdeberta_base_fine_task2'
