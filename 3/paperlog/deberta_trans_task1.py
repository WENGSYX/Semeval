...
train = pd.read_pickle('it_subtask1_train_en.pk')
train.extend(pd.read_pickle('en_subtask1_valid.pk'))

#train.extend(pd.read_pickle('fr_subtask1_train.pk'))
train.extend(pd.read_pickle('fr_subtask1_train_en.pk'))

#train = pd.read_pickle('it_subtask1_train.pk')
train.extend(pd.read_pickle('it_subtask1_train_en.pk'))
...
"""
valid_fr = pd.read_pickle('fr_subtask1_test_en.pk')
valid_it = pd.read_pickle('it_subtask1_test_en.pk')
