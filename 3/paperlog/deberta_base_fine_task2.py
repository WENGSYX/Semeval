...
CFG = { #训练的参数配置
    'fold_num': 5, #五折交叉验证
    'seed': 42,
    'model': r'C:\semeval\3\paperlog\deberta_base_task1\0_0.7826785722785905_0.6963036093545505_0.6961926573713977_model', #预训练模型
...
log_name = 'deberta_base_fine_task2'
